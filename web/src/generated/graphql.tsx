...
export type Home = {
  ...
  created_at: Scalars['DateTime']
  updated_at: Scalars['DateTime']
  Social?: Maybe<Array<Maybe<ComponentHomeSocial>>>
  published_at?: Maybe<Scalars['DateTime']>
}

export type HomeInput = {
  Social?: Maybe<Array<ComponentHomeSocialInput>>
  published_at?: Maybe<Scalars['DateTime']>
  created_by?: Maybe<Scalars['ID']>
  updated_by?: Maybe<Scalars['ID']>
}
...
export type EditHomeInput = {
  Social?: Maybe<Array<Maybe<EditComponentHomeSocialInput>>>
  published_at?: Maybe<Scalars['DateTime']>
  created_by?: Maybe<Scalars['ID']>
  updated_by?: Maybe<Scalars['ID']>
}
...
export type PostGroupBy = {
  ...
  deck?: Maybe<Array<Maybe<PostConnectionDeck>>>
  lede?: Maybe<Array<Maybe<PostConnectionLede>>>
  body?: Maybe<Array<Maybe<PostConnectionBody>>>
  image?: Maybe<Array<Maybe<PostConnectionImage>>>
  originalId?: Maybe<Array<Maybe<PostConnectionOriginalId>>>
  imageUrl?: Maybe<Array<Maybe<PostConnectionImageUrl>>>
...
export type PostConnectionDeck = {
  __typename?: 'PostConnectionDeck'
  key?: Maybe<Scalars['String']>
  connection?: Maybe<PostConnection>
}

export type PostConnectionLede = {
  __typename?: 'PostConnectionLede'
  key?: Maybe<Scalars['String']>
  connection?: Maybe<PostConnection>
}
...
export type PostConnectionOriginalId = {
  __typename?: 'PostConnectionOriginalId'
  key?: Maybe<Scalars['ID']>
  connection?: Maybe<PostConnection>
}

export type PostConnectionImageUrl = {
  __typename?: 'PostConnectionImageUrl'
  key?: Maybe<Scalars['String']>
  connection?: Maybe<PostConnection>
}
...
export type ComponentHomeSocial = {
  __typename?: 'ComponentHomeSocial'
  id: Scalars['ID']
  title: Scalars['String']
  url: Scalars['String']
...
export type ComponentHomeSocialInput = {
  title: Scalars['String']
  url: Scalars['String']
  color: Scalars['String']
}

export type EditComponentHomeSocialInput = {
  id?: Maybe<Scalars['ID']>
  title?: Maybe<Scalars['String']>
  url?: Maybe<Scalars['String']>
  color?: Maybe<Scalars['String']>
...
export type Morph =
  ...
  | PostConnectionBody
  | PostConnectionImage
  | PostConnectionOriginalId
  | PostConnectionImageUrl
  | PostConnectionSlug
...
export type PostBodyFragment = { __typename?: 'Post' } & Pick<
  Post,
  'id' | 'created_at' | 'updated_at' | 'title' | 'lede' | 'slug'
> & {
    categories?: Maybe<
      Array<
        Maybe<{ __typename?: 'Category' } & Pick<Category, 'name' | 'color'>>
      >
    >
...
export type BrowsePostsQuery = { __typename?: 'BrowsePostsQuery' } & {
  posts?: Maybe<Array<Maybe<{ __typename?: 'Post' } & PostBodyFragment>>>
}
      ...
      Maybe<
        ...
        > & {
            categories?: Maybe<
              Array<
                Maybe<
                  { __typename?: 'Category' } & Pick<Category, 'name' | 'color'>
                >
              >
            >
            image?: Maybe<
...
export type GetSocialsQuery = { __typename?: 'Query' } & {
  home?: Maybe<
    { __typename?: 'Home' } & {
      Social?: Maybe<
        Array<
          Maybe<
            { __typename?: 'ComponentHomeSocial' } & Pick<
              ComponentHomeSocial,
              'title' | 'url' | 'color'
            >
          >
...
export const PostBodyFragmentDoc = gql`
...
export const BrowsePostsDocument = gql`
  query browsePosts($sort: String, $limit: Int, $start: Int, $where: JSON) {
 ...
 *
 * To run a query within a React component, call `useBrowsePostsQuery` and pass it any options that fit your needs.
 * When your component renders, `useBrowsePostsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useBrowsePostsQuery({
 *   variables: {
 *      sort: // value for 'sort'
...
export function useBrowsePostsQuery(
  ...
  return Apollo.useQuery<BrowsePostsQuery, BrowsePostsQueryVariables>(
    BrowsePostsDocument,
    baseOptions
  )
}
export function useBrowsePostsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    BrowsePostsQuery,
    BrowsePostsQueryVariables
  >
) {
  return Apollo.useLazyQuery<BrowsePostsQuery, BrowsePostsQueryVariables>(
    BrowsePostsDocument,
    baseOptions
  )
}
export type BrowsePostsQueryHookResult = ReturnType<typeof useBrowsePostsQuery>
export type BrowsePostsLazyQueryHookResult = ReturnType<
  typeof useBrowsePostsLazyQuery
>
export type BrowsePostsQueryResult = Apollo.QueryResult<
  BrowsePostsQuery,
  BrowsePostsQueryVariables
>
...
export function useGetSocialsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    GetSocialsQuery,
    GetSocialsQueryVariables
  >
) {
  return Apollo.useQuery<GetSocialsQuery, GetSocialsQueryVariables>(
    GetSocialsDocument,
    baseOptions
  )
}
export function useGetSocialsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    GetSocialsQuery,
    GetSocialsQueryVariables
  >
) {
  return Apollo.useLazyQuery<GetSocialsQuery, GetSocialsQueryVariables>(
    GetSocialsDocument,
    baseOptions
  )
}
export type GetSocialsQueryHookResult = ReturnType<typeof useGetSocialsQuery>
export type GetSocialsLazyQueryHookResult = ReturnType<
  typeof useGetSocialsLazyQuery
>
export type GetSocialsQueryResult = Apollo.QueryResult<
  GetSocialsQuery,
  GetSocialsQueryVariables
>
